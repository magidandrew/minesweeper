...
def create_mine_mat(x: int, y: int, mine_num: int = 20, mine_prob: float = .2) -> list[list[int]]:
    if mine_num > x*y:
        raise RuntimeError("Too many mines for board!")
...
if __name__ == "__main__":
    # main()
    mat = create_mine_mat(8, 8, mine_num=10)
    print_mat(mat)
    print("hints")
